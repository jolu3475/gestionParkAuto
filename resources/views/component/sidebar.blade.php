...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dash.index') }}" {{-- class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" --}} @class([
                    'flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-gray-700 group',
                    'hover:bg-gray-100' => !Str::startsWith($route, 'dash.index'),
                    'bg-gray-100' => Str::startsWith($route, 'dash.index'),
                ])>
                    <i
            ...
            <li>
                <a href="{{ route('dash.maintenance') }}" {{-- class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" --}} @class([
                    'flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-gray-700 group',
                    'hover:bg-gray-100' => !Str::startsWith($route, 'dash.main'),
                    'bg-gray-100' => Str::startsWith($route, 'dash.main'),
                ])>
                    <i
