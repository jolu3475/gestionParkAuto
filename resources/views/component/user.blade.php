<li>
    <a href="{{ route('dash.users.users') }}" {{-- class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" --}} @class([
        'flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-gray-700 group',
        'hover:bg-gray-100' => !Str::startsWith($route, 'dash.user'),
        'bg-gray-100' => Str::startsWith($route, 'dash.user'),
    ])>
        <i
            class="fa-solid fa-users flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"></i>
...
<li>
    <a href="{{ route('dash.intituler') }}" {{-- class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" --}} @class([
        ...
        <span class="flex-1 ms-3 whitespace-nowrap">Intituler</span>
    </a>
</li>
